        ...
        <div class="mt-8 bg-white dark:bg-gray-800 overflow-hidden shadow sm:rounded-lg">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2">
                ...
                <div class="p-6">
                    ...
                    <p>
                        <a href="{{route('directorio.nueva')}}" class="btn btn-primary">Agregar nuevo</a>
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{$item->telefono}}</td>
                                <td>
                                    <a href="{{ route('contacto.index', $item->codigoEntrada) }}" class="btn btn-info">Ver</a>
                                </td>
                                <td>
                                    <a href="{{ route('directorio.eliminar', $item->codigoEntrada) }}" class="btn btn-danger">Eliminar</a>
                                </td>
                            </tr>
                            @endforeach
                        </tbody>
